...
TEMP2=".caffemodel"
python $SPLT_CODE/partseg3d/train.py $EXP_DIR/$CAT \
    --categories $CAT \
    ...
    --network $CAT$TEMP1 \
    --prefix net_deform2 \
    --base_lr 0.0001 --lr_decay 0.1 --stepsize 2000 --num_iter 15000 --test_interval 20 --snapshot_interval 100 \
    2>&1 | tee $EXP_DIR/$CAT/train_net_deform_nobn.log; done ;
fi
