...
parser.add_argument('--batch', type=int, default=10, help='Batch Size per GPU during training')
parser.add_argument('--epoch', type=int, default=201, help='Epoch to run')
...
parser.add_argument('--model_path', type=str, default=None,help='Resume model path')
parser.add_argument('--wd', type=float, default=0, help='Weight Decay [Default: 0.0]')
parser.add_argument('--baselr', type=float, default=3e-3, help='Lr [Default: 3e-3]')
parser.add_argument('--graphnum',  type=str )#'--names-list', type=int, nargs='+', help='number of graph', required=True)
parser.add_argument('--featnum',  type=str )#,'--names-list' , type=int,  nargs='+', help='number of feature', required=True)
#parser.add_argument('-n', '--names-list', nargs='+', default=[])

FLAGS = parser.parse_args()

graphnum = np.array(FLAGS.graphnum.split(",")).astype(int)
featnum = np.array(FLAGS.featnum.split(",")).astype(int) 
...
BASE_LEARNING_RATE = FLAGS.baselr #0.003
MOMENTUM = 0.9
