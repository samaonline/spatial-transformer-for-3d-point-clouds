...
parser.add_argument('--graphnum',  type=str )
parser.add_argument('--featnum',  type=str )
parser.add_argument('--output_dir', type=str, default='affineF', help='Directory that stores all training logs and trained models')
...
def predict():
  ...
  with tf.device('/gpu:'+str(gpu_to_use)):
    ...
    seg_pred = model.get_model(pointclouds_ph, input_label_ph, \
        ...
        batch_size=batch_size, num_point=point_num, weight_decay=0.0, bn_decay=None,  graphnum=graphnum, featnum = featnum)
